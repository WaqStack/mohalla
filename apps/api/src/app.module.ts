 ...
 *
 * All 17 module shells are registered here so the boundary set is complete and
 * the dependency-direction check has something real to verify. They export
 * nothing and provide nothing, so registering them cannot create a coupling.
 *
 * The only routes the process serves are the two health endpoints.
 */
@Module({
  imports: [
    HealthModule,
